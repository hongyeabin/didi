...
<FORM 
	name='frm' method='POST' action='./prcreateProc.jsp' enctype="multipart/form-data"
	onsubmit="return inCheck(this)">
  <TABLE>
    <TR>
      <TH>사진</TH>
      <TD><input type="file" name = "fname" accept=".jpg,.png,.gif"></TD>
      <td>사진은 jpg , png , gif 파일만 가능합니다.</td>
    </TR>
    <TR>
      <TH>*아이디</TH>
      <TD>	<input type="text" name = "id" size="17" >
      		<button type="button" onclick="idCheck(document.frm.id.value)"> ID중복 확인</button>
      </TD>
      <td>아이디는 필수항목 입니다.</td>
    </TR>
    <TR>
      <TH>*비밀번호</TH>
      <TD>	<input type="password" name = "passwd" size="17">
      </TD>
      <td>비밀번호는 필수항목입니다.</td>
    </TR>
    <TR>
      <TH>*비밀번호 확인</TH>
      <TD>	<input type="password" name = "repasswd" size="17">
      </TD>
      <td>비밀번호를 한번더 입력해주세요.</td>
    </TR>
    <TR>
      <TH>*이름</TH>
    ...
    <TR>
      <TH>전화번호</TH>
      <TD>	<input type="text" name = "tel" size="18">
      </TD>
      <td></td>
    </TR>
    <TR>
